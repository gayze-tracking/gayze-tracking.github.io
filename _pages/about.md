...
<a href="javascript:void(0);" onclick='show_hide_toggle("abstract_3")'> Upoor, Y. R. (2019). LumpenAI: A Contextual Bandits Approach for Fraud- and Indigence-Aware Algorithmic Resource Allocation. <em> Proceedings of the 36th International Conference on Machine Learning (ICML'19)</em>. </a>

<p class='abstract' style='display: none; margin-left:10%' id='abstract_3'> The increasing demand for material goods and public services is escalating, due to market forces and rising unemployment rates. Meanwhile, available government resources are limited and governments are constrained in increasing available resources due to fraudulent recipients. The emergence of machine learning algorithms in public resource allocation opens the opportunity to improve utilization and efficiency. Yet, a primary barrier to reliable algorithmic allocation is poor predictive capabilities around which individuals are most prone to fraud and which are most deserving of material goods. We frame this resource allocation problem as a contextual bandit problem, where the recipients' features define the context and the reward is defined as a function of the proportion of resources used for government-sanctioned purposes. We derive a novel algorithm (LumpenAI) to recommend which recipients are most worthy of resources which achieves sublinear regret with high probability under natural assumptions over the recipient feature space and set of resources. We then test our algorithm empirically, using a large-scale, real-world dataset provided by the Department of Human Services of a mid-sized American city, which includes a history of recipients' past criminal, child protective services, public behavioral health, SNAP, TANF, and Medicaid involvement, as well as their zip code and demographics (sans race). We validated our algorithm by using income and debt levels among individuals provided from the latest copy of their W-2 and bank statements, finding that our algorithm's positive recommendations for resource allocation are highly correlated with indigence among data subjects. We estimate that our algorithm would improve resource allocation efficiency and fraud prevention significantly, largely due to indigent recipients spending less on frivolous goods like name-brand cereal and going to the doctor for a cough. </p>
