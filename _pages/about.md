...
Anon, Y. (2021). <a href="javascript:void(0);" onclick='show_hide_toggle("abstract_0")' id="paper_0"> Classifying Ego-Dystonic Sexual Orientation on Social Media for Public Health Intervention.</a> <em> Proceedings of The Web Conference 2021</em>. 
...
Anon, Y. (2021). <a href="javascript:void(0);" onclick='show_hide_toggle("abstract_2")' id="paper_01">  “Gays Can Have a Few Rights, as a Treat:” A Language Model for Neutralizing Political Bias in News Articles.</a> <em>Proceedings of the ACM on Human-Computer Interaction, CSCW</em>.
